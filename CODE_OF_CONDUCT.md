...
leaders responsible for enforcement by
[opening a private security advisory](https://github.com/2026osscontest/nosy/security/advisories/new),
which is visible only to the maintainers. If the matter does not need to stay private, an
[issue](https://github.com/2026osscontest/nosy/issues) works too.
